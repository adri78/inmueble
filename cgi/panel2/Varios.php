...
<head>
    <meta charset="utf-8">
    <title>Panel de Control-Varios</title>
        ...
        <div class="col-xs-12 col-sm-9 content" id="app1">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title"><a href="javascript:void(0);" class="toggle-sidebar"><span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Maximize Panel"></span></a> Ajuste Varios</h3>
                </div>
                <div class="panel-body">
                    <div class="content-row" id="Contenido">
                        <?php
                            include("job/TVarios.php");
                        ?>
                    </div>
                </div><!-- panel body -->
            </div>
