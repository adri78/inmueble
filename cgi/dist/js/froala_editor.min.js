!function(a) {
        ...
        b.prototype.destroy = function() {
            ...
            0 === this.shared.count) {
                for (var c in this.shared)
                    this.shared.hasOwnProperty(c) && (this.shared[c],
    ...
    a.FE.LinkRegExCommon = "(([" + c + "])|([" + c + "](\\.|-|_|--))){1,}[" + c + "]{1,}",
                    ...
                    if (f.rangeCount) {
                        ...
                        i.nodeType == Node.ELEMENT_NODE) {
                            ...
                            if (i.childNodes.length > 0 && i.childNodes[h.startOffset]) {
                                ...
                                !h.collapsed && i.nextSibling && i.nextSibling.nodeType == Node.ELEMENT_NODE && (g = i.nextSibling) && g.textContent.replace(/\u200B/g, "") === c().replace(/\u200B/g, "") && (i = g,
                                    j = !0);
                    ...
                    if (f.rangeCount) {
                        ...
                        if (i.nodeType == Node.ELEMENT_NODE) {
                            ...
                            i.childNodes.length > 0 && i.childNodes[h.endOffset] && a(i.childNodes[h.endOffset]).text() === c() ? (i = i.childNodes[h.endOffset],
                                j = !0) : !h.collapsed && i.previousSibling && i.previousSibling.nodeType == Node.ELEMENT_NODE ? (g = i.previousSibling) && g.textContent.replace(/\u200B/g, "") === c().replace(/\u200B/g, "") && (i = g,
                ...
                if (b.$wp) {
                    ...
                    for (d = 0; d < f.length; d++)
                        if (f[d].startContainer !== b.doc || b.browser.msie) {
                            ...
                            void 0 !== i && i || !h || (a(".fr-marker").remove(),
            ...
            function c(c, d) {
                ...
                if (!b.html.isPreformatted(h)) {
                    ...
                    for (var i = "", j = 0; j < g.length; j++)
                        32 != g.charCodeAt(j) || 0 !== j && 32 != i.charCodeAt(j - 1) ? i += g[j] : i += a.FE.UNICODE_NBSP;
        ...
        a.FE.MODULES.html = function(b) {
            ...
            function h(c) {
                ...
                d = a.merge(d, b.opts.htmlAllowedEmptyTags),
                    d = void 0 === c ? a.merge(d, a.FE.BLOCK_TAGS) : a.merge(d, a.FE.NO_DELETE_TAGS);
                var e, f;
                e = b.el.querySelectorAll("*:empty:not(" + d.join("):not(") + "):not(.fr-marker)");
                do {
                    f = !1;
                    for (var g = 0; g < e.length; g++)
                        0 !== e[g].attributes.length && void 0 === e[g].getAttribute("href") || (e[g].parentNode.removeChild(e[g]),
                            f = !0);
                    e = b.el.querySelectorAll("*:empty:not(" + d.join("):not(") + "):not(.fr-marker)")
                } while (e.length && f)
            }
                    ...
                    for (var f = b.doc.createDocumentFragment(), g = null, h = !1, i = a.firstChild, j = !1; i; ) {
                        ...
                        if (i.nodeType == Node.ELEMENT_NODE && (b.node.isBlock(i) || b.opts.htmlDoNotWrapTags.indexOf(i.tagName.toLowerCase()) >= 0 && !b.node.hasClass(i, "fr-marker")))
                            ...
                            d && g.setAttribute("class", "fr-temp-div"),
                                ...
                                f.appendChild(g)) : !1 === h && (g.appendChild(b.doc.createElement("br")),
                            d && g.setAttribute("class", "fr-temp-div"),
                                g.setAttribute("data-empty", !0)),
                                g = null;
                        else {
                                ...
                                if (k[m].selectorText && k[m].style.cssText.length > 0) {
                                    ...
                                    for (f = 0; f < o.length; f++) {
                                        !o[f].getAttribute("fr-original-style") && o[f].getAttribute("style") ? (o[f].setAttribute("fr-original-style", o[f].getAttribute("style")),
                                            g.push(o[f])) : o[f].getAttribute("fr-original-style") || (o[f].setAttribute("fr-original-style", ""),
                                            g.push(o[f])),
                                        h[o[f]] || (h[o[f]] = {});
                                        for (var q = 1e3 * l + B(k[m].selectorText), s = k[m].style.cssText.split(";"), t = 0; t < s.length; t++) {
                                            var u = s[t].trim().split(":")[0];
                                            u.match(j) || (h[o[f]][u] || (h[o[f]][u] = 0,
                                            (o[f].getAttribute("fr-original-style") || "").indexOf(u + ":") >= 0 && (h[o[f]][u] = 1e4)),
                                            q >= h[o[f]][u] && (h[o[f]][u] = q,
                                            s[t].trim().length && i.push([o[f], u.trim(), s[t].trim().split(":")[1].trim(), q])))
                                        }
                                    }
                                }
                    }
                    ...
                    for (e = 0; e < g.length; e++)
                        ...
                        (g[e].getAttribute("fr-original-style") || "").trim().length > 0) {
                            ...
                            for (f = 0; f < w.length; f++)
                                w[f].indexOf(":") > 0 && (g[e].style[w[f].split(":")[0].trim()] = w[f].split(":")[1].trim())
                        }
                }
            ...
            function F() {
                var c = function(c, d) {
                    ...
                    , d = function() {
                    var c, d = null;
                    return b.win.getSelection ? (c = b.win.getSelection()) && c.rangeCount && (d = c.getRangeAt(0).commonAncestorContainer,
                ...
                if (void 0 !== b.win.getSelection) {
                    ...
                    void 0 !== b.doc.selection && "Text" == b.doc.selection.type && (e = b.doc.selection.createRange().htmlText);
                return e
            }
            function G(a) {
                var c = b.doc.createElement("div");
            ...
            function L(c) {
                ...
                if ((b.el.textContent.match(/\u200B/g) || []).length - b.el.querySelectorAll(".fr-marker").length == e)
                    return !1;
                var f, g;
                do {
                    g = !1,
                        f = b.el.querySelectorAll("*:not(.fr-marker)");
                    for (var h = 0; h < f.length; h++) {
                        var i = f[h];
                        if (d != i) {
                            var j = i.textContent;
                            0 === i.children.length && 1 === j.length && 8203 == j.charCodeAt(0) && "TD" !== i.tagName && (a(i).remove(),
                                g = !0)
                        }
                    }
                } while (g)
        ...
        a.FE.MODULES.size = function(a) {
            ...
            function d() {
                if (!a.$wp)
                    return !1;
                c(),
                a.$iframe && (a.events.on("keyup keydown", function() {
                    setTimeout(b, 0)
                }, !0),
            ...
            function j(c) {
                ...
                if (!b.node.isBlock(d) && b.node.isEditable(d)) {
                    ...
                    if (d.nodeType == Node.TEXT_NODE) {
                        ...
                        0 === d.textContent.length ? i && b.opts.keepFormatOnDelete ? a(d).after(a.FE.INVISIBLE_SPACE + a.FE.MARKERS) : (2 != d.parentNode.childNodes.length || d.parentNode != c.parentNode) && 1 != d.parentNode.childNodes.length || b.node.isBlock(d.parentNode) || b.node.isElement(d.parentNode) ? (a(d).after(a.FE.MARKERS),
                        ...
                        b.node.isDeletable(d) ? (a(d).after(a.FE.MARKERS),
                            ...
                            a(c).replaceWith(a.FE.MARKERS)) : !1 !== b.events.trigger("node.remove", [a(d)]) && (a(d).after(a.FE.MARKERS),
                            a(d).remove())
            ...
            function m(d) {
                ...
                if (!b.node.isBlock(e) && b.node.isEditable(e)) {
                    ...
                    e.textContent.length && (e.textContent = e.textContent.substring(h(e.textContent, !0), e.textContent.length))) : b.node.isDeletable(e) ? (a(e).before(a.FE.MARKERS),
                        a(e).remove()) : !1 !== b.events.trigger("node.remove", [a(e)]) && (a(e).before(a.FE.MARKERS),
                        a(e).remove()),
                        a(d).remove()
        ...
        a.FE.MODULES.keys = function(b) {
            ...
            function f(a) {
                b.selection.isCollapsed() ? b.helpers.isIOS() ? I = b.snapshot.get() : (b.cursor.backspace(),
                    a.preventDefault(),
            ...
            function h(c) {
                ...
                if (!b.helpers.isMobile() && d && "A" == d.tagName) {
                    ...
                    if (e) {
                        ...
                        !e.nextSibling && e.parentNode && "A" == e.parentNode.tagName ? (e.parentNode.insertAdjacentHTML("afterend", "&nbsp;" + a.FE.MARKERS),
            ...
            function p(i) {
                ...
                if ((b.selection.isFull() && !b.opts.keepFormatOnDelete && !b.placeholder.isVisible() || m && b.placeholder.isVisible() && b.opts.keepFormatOnDelete) && (l || m) && (o(),
                    !w(j)))
            ...
            function x(c) {
                var d = c.which;
                if (u(c) || d >= 37 && d <= 40 || !w(d) && d != a.FE.KEYCODE.DELETE && d != a.FE.KEYCODE.BACKSPACE && d != a.FE.KEYCODE.ENTER && d != a.FE.KEYCODE.IME)
                    return !0;
                F || (G = b.snapshot.get(),
            ...
            function y(a) {
                ...
                if (u(a) || c >= 37 && c <= 40)
                    return !0;
                G && F ? (b.undo.saveStep(G),
                    G = null) : void 0 !== c && 0 !== c || G || F || b.undo.saveStep()
            }
            function z() {
                F && (clearTimeout(F),
                    b.undo.saveStep(),
            ...
            function C(c) {
                var d = b.el.childNodes
                    , e = b.html.defaultTag();
                return !(!c.target || c.target === b.el) || (0 === d.length || void (b.$el.outerHeight() - c.offsetY <= 10 ? B(d[d.length - 1]) && (e ? b.$el.append("<" + e + ">" + a.FE.MARKERS + "<br></" + e + ">") : b.$el.append(a.FE.MARKERS + "<br>"),
                    b.selection.restore(),
        ...
        a.FE.MODULES.accessibility = function(b) {
            ...
            function t() {
                b.shared.$f_el && (b.events.disableBlur(),
                    b.shared.$f_el.blur(),
                    b.shared.$f_el = null),
                !1 !== b.events.trigger("toolbar.focusEditor") && (b.events.disableBlur(),
                    b.$el.focus(),
                    b.events.focus())
            }
            function u(a) {
                if (b.shared.$f_el) {
                    ...
                    b.opts.toolbarInline && (b.events.disableBlur(),
                        ...
                        b.shared.$f_el = null,
                    !1 !== b.events.trigger("toolbar.esc") && (b.popups.hide(a.parent()),
            ...
            function y(c) {
                ...
                return {
                    _tiKeydown: function(g) {
                        ...
                        if (!1 === i.events.trigger("popup.tab", [g]))
                            return !1;
                        var j = g.which
            ...
            function D(c) {
                ...
                if (c.which == a.FE.KEYCODE.F10 && !d && !c.shiftKey && c.altKey) {
                    ...
                    var e = b.popups.areVisible(b)
                        , g = !1;
                    return e && (g = f(e.children().not(".fr-buttons"))),
                    g || k(),
                        b.shared.with_kb = !1,
                        c.preventDefault(),
                        c.stopPropagation(),
        ...
        a.FE.MODULES.format = function(b) {
            ...
            function h(h, i) {
                ...
                i.style && delete i.style,
                    ...
                    b.markers.insert();
                    b.$el.find(".fr-marker").replaceWith(c(h, i) + a.FE.INVISIBLE_SPACE + a.FE.MARKERS + d(h)),
                        b.selection.restore()
                } else {
                    b.selection.save();
            ...
            function i(a, c, d, g) {
                ...
                if (a.parents(c).length || void 0 === c) {
                    ...
                    if (k.is(b.$el) || b.node.isBlock(k.get(0)))
                        return !1;
                    for (; !b.node.isBlock(k.parent().get(0)) && (void 0 === c || void 0 !== c && !f(k.get(0), e(c, d))); )
                ...
                for (var f = !0; f; ) {
                    ...
                    for (var g = b.$el.find(".fr-marker"), h = 0; h < g.length; h++) {
                        ...
                        if (k.attr("data-cloned") || e || (l = k.clone().removeClass("fr-marker").addClass("fr-clone"),
                            !0 === k.data("type") ? k.attr("data-cloned", !0).after(l) : k.attr("data-cloned", !0).before(l)),
                            i(k, c, d, e)) {
                            f = !0;
                            break
                        }
            ...
            function d(c, d) {
                if (!1 !== b.events.trigger("commands.before", a.merge([c], d || []))) {
                    var e = a.FE.COMMANDS[c] && a.FE.COMMANDS[c].callback || i[c]
                        , f = !0
                        , g = !1;
                    a.FE.COMMANDS[c] && (void 0 !== a.FE.COMMANDS[c].focus && (f = a.FE.COMMANDS[c].focus),
                    void 0 !== a.FE.COMMANDS[c].accessibilityFocus && (g = a.FE.COMMANDS[c].accessibilityFocus)),
                    (!b.core.hasFocus() && f && !b.popups.areVisible() || !b.core.hasFocus() && g && b.accessibility.hasFocus()) && b.events.focus(!0),
                    a.FE.COMMANDS[c] && !1 !== a.FE.COMMANDS[c].undo && (b.$el.find(".fr-marker").length && (b.events.disableBlur(),
                        b.selection.restore()),
                        b.undo.saveStep()),
            ...
            function h() {
                b.events.on("keydown", function(a) {
                    ...
                    b.events.on("mouseup", function() {
                        var c = b.selection.element();
                        c == b.selection.endElement() && c && "HR" == c.tagName && (c.nextSibling && (b.node.isBlock(c.nextSibling) ? b.selection.setAtStart(c.nextSibling) : a(c).after(a.FE.MARKERS)),
                            b.selection.restore())
                    })
            }
            var i = {
        ...
        a.FE.MODULES.paste = function(b) {
            ...
            function e(a) {
                ...
                a && a.clipboardData && a.clipboardData.getData) {
                    ...
                    if (b.helpers.isArray(d))
                        ...
                        c = d;
                    if (/text\/rtf/.test(c) && (t = a.clipboardData.getData("text/rtf")),
                        /text\/html/.test(c) && !b.browser.safari ? s = a.clipboardData.getData("text/html") : /text\/rtf/.test(c) && b.browser.safari ? s = t : /text\/plain/.test(c) && !b.browser.mozilla && (s = b.html.escapeEntities(a.clipboardData.getData("text/plain")).replace(/\n/g, "<br>")),
                    "" !== s)
                        return j(),
                ...
                c && c.dataTransfer && c.dataTransfer.getData) {
                    ...
                    "" !== s) {
                        ...
                        if (!1 !== b.markers.insertAtPoint(c)) {
                            ...
                            return a(g).replaceWith(a.FE.MARKERS),
                                j(),
            ...
            function j() {
                ...
                (!a || a && !1 !== b.events.trigger("paste.wordPaste", [s])) && l(s, a)
            }
            function k(c) {
                var d = null;
                try {
            ...
            function l(c, d, e) {
                ...
                if (c.indexOf('id="docs-internal-guid') >= 0 && (c = c.replace(/^[\w\W\s\S]* id="docs-internal-guid[^>]*>([\w\W\s\S]*)<\/b>[\w\W\s\S]*$/g, "$1"),
                    ...
                    !d) {
                    var n = k(c);
                    if (n && (c = b.win.localStorage.getItem("fr-copied-html")),
                        !n) {
                ...
                "" !== c) {
                    ...
                    var u = b.selection.element()
                        , w = !1;
                    if (u && a(u).parentsUntil(b.el, "ul, ol").length && (w = !0),
                        w) {
                        var x = r.children;
                    ...
                    if (b.opts.enter == a.FE.ENTER_BR)
                        for (g = r.querySelectorAll("p, div"),
                                 f = g.length - 1; f >= 0; f--)
                            j = g[f],
                            0 === j.attributes.length && (j.outerHTML = j.innerHTML + (j.nextSibling && !b.node.isEmpty(j) ? "<br>" : ""));
                    else if (b.opts.enter == a.FE.ENTER_DIV)
                        for (g = r.getElementsByTagName("p"),
                                 f = g.length - 1; f >= 0; f--)
                            j = g[f],
                                j.outerHTML = "<div>" + j.innerHTML + "</div>";
                    else
                        b.opts.enter == a.FE.ENTER_P && 1 == r.childNodes.length && "P" == r.childNodes[0].tagName && (r.childNodes[0].outerHTML = r.childNodes[0].innerHTML);
                    c = r.innerHTML,
                        b.html.insert(c, !0)
                }
                m(),
        ...
        a.FE.MODULES.button = function(b) {
            ...
            function f(a) {
                ...
                for (var b = a.data("cmd"), c = []; void 0 !== a.data("param" + (c.length + 1)); )
            ...
            function h(c) {
                ...
                a.FE.COMMANDS[c.data("cmd")] && !1 !== a.FE.COMMANDS[c.data("cmd")].refreshAfterCallback && d.button.bulkRefresh())
            }
            function i(b) {
                h(a(b.currentTarget))
            }
            ...
            function o(a, c, d) {
                if (b.helpers.isMobile() && !1 === c.showOnMobile)
                    return "";
            ...
            function r(c) {
                ...
                if (!1 === b.events.trigger("buttons.refresh"))
                    return !0;
                setTimeout(function() {
        ...
        a.FE.MODULES.modals = function(b) {
            ...
            function d(c, d) {
                ...
                return e += '<div class="fr-modal-head">' + c + '<i title="' + b.language.translate("Cancel") + '" class="fa fa-times fr-modal-close"></i></div>',
            ...
            function k(a) {
                for (var b in n)
                    if (n.hasOwnProperty(b) && j(b) && (void 0 === a || n[b].$modal.data("instance") == a))
                        return n[b].$modal;
                return !1
            }
            function l() {
        ...
        a.FE.MODULES.popups = function(b) {
            ...
            function g(a) {
                for (var b in x)
                    if (x.hasOwnProperty(b) && f(b) && (void 0 === a || x[b].data("instance") == a))
                        return x[b];
                return !1
            }
            function h(a) {
            ...
            function s(c) {
                ...
                return {
                    ...
                    _doPlaceholder: function() {
                        0 === a(this).next().length && a(this).attr("placeholder") && a(this).after('<label for="' + a(this).attr("id") + '">' + a(this).attr("placeholder") + "</label>"),
        ...
        a.FE.MODULES.position = function(b) {
            ...
            function j() {
                ...
                -1 !== c.position.indexOf("sticky") && !b.helpers.isIOS() && !b.helpers.isAndroid() && !b.browser.chrome
            }
            function k() {
                if (!j())
        ...
        a.FE.MODULES.toolbar = function(b) {
            ...
            function j() {
                if (!1 === b.events.trigger("toolbar.show"))
                    return !1;
                b.$tb.show()
            }
            function k(c) {
            ...
            function q() {
                if (b.$sc = a(b.opts.scrollableContainer).first(),
                    !b.$wp)
                    return !1;
                b.opts.toolbarContainer ? (b.shared.$tb ? (b.$tb = b.shared.$tb,
