...
!function(a) {
    ...
    a.extend(a.FE.POPUP_TEMPLATES, {
        ...
        a.extend(a.FE.DEFAULTS, {
            videoAllowedTypes: ["mp4", "webm", "ogg","avi","mpeg","3gp"],
        ...
        a.FE.PLUGINS.video = function(b) {
            ...
            function f(a) {
                ...
                h >= 0 && (e = " fr-active",
                (h > g && g >= 0 || h > i && i >= 0) && (e = ""),
                    f = '<div class="fr-video-by-url-layer fr-layer' + e + '" id="fr-video-by-url-layer-' + b.id + '"><div class="fr-input-line"><input id="fr-video-by-url-layer-text-' + b.id + '" type="text" placeholder="' + b.language.translate("Pegar URL") + '" tabIndex="1" aria-required="true"></div><div class="fr-action-buttons"><button type="button" class="fr-command fr-submit" data-cmd="videoInsertByURL" tabIndex="2" role="button">' + b.language.translate("Insertar") + "</button></div></div>");
                var j = "";
                i >= 0 && (e = " fr-active",
                (i > g && g >= 0 || i > h && h >= 0) && (e = ""),
            ...
            function v(c) {
                try {
                    var d = a(c).find("Location").text()
                        , e = a(c).find("Key").text();
                    return !1 === b.events.trigger("video.uploadedToS3", [d, e, c], !0) ? (b.edit.on(),
                        !1) : d
                } catch (f) {
                    return S(ua, c),
                        !1
            ...
            function H() {
                ...
                if (ya)
                    for (c = 0; c < ya.length; c++)
                        e.indexOf(ya[c].getAttribute("src")) < 0 && b.events.trigger("video.removed", [a(ya[c])]);
                ya = d
            }
            function I() {
                qa || G(),
            ...
            function P(a) {
                if (void 0 !== a && a.length > 0) {
                    if (!1 === b.events.trigger("video.beforeUpload", [a]))
                        return !1;
                    var c = a[0];
            ...
            function S(a, c) {
                ...
                ra && ra.find("video").addClass("fr-error"),
                    q(b.language.translate("Algo ha fallado, vuelva a intertarlo.")),
            ...
            function W(a) {
                if (a)
                    return b.popups.onRefresh("video.size", U),
                        !0;
                var c = "";
                ...
                b.helpers.isMobile() && (b.events.$on(b.$el, "touchstart", "span.fr-video", function() {
                    ...
                    b.events.on("keydown", function(c) {
                        ...
                        return !ra || d != a.FE.KEYCODE.BACKSPACE && d != a.FE.KEYCODE.DELETE ? ra && d == a.FE.KEYCODE.ESC ? (K(!0),
                            c.preventDefault(),
                            !1) : ra && d != a.FE.KEYCODE.F10 && !b.keys.isBrowserAction(c) ? (c.preventDefault(),
